...
function medirTempoDeExecucao(target, propertyKey, descriptor) {
    ...
    descriptor.value = function () {
        ...
        console.log("Medindo o tempo de execu\u00E7\u00E3o do m\u00E9todo ".concat(propertyKey));
        var t1 = performance.now();
        var resultado = metodoOriginal.apply(this, args);
        var t2 = performance.now();
        console.log("O m\u00E9todo ".concat(propertyKey, " demorou ").concat(t2 - t1, " ms para ser executado"));
        return resultado;
    };
    return descriptor;
}
